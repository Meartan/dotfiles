...
" --------------
" any constant
hi Constant         guifg=#8cd0d3                                   gui=bold
hi Constant         ctermfg=116                                     cterm=bold
" strings
...
" true, false
hi Boolean          guifg=#8cd0d3                                   gui=bold
hi Boolean          ctermfg=116                                     cterm=bold
" float
...
" ---------------
" any statement
hi Statement        guifg=#b3d38c                                   gui=bold
...
" case, default
hi Label            guifg=#b3d38c                                   gui=bold
hi Label            ctermfg=150                                     cterm=none
" sizeof, +, *
hi Operator         guifg=#b3d38c                                   gui=bold
...
hi PreProc          guifg=#e9dfaf                                   gui=bold
hi PreProc          ctermfg=187                                     cterm=none
" #include
hi Include          guifg=#e9dfaf                                   gui=bold
hi Include          ctermfg=187                                     cterm=none
" #define
hi Define           guifg=#e9dfaf                                   gui=bold
...
" ----------
" int, long, char
hi Type             guifg=#93d6a9                                   gui=bold
hi Type             ctermfg=115                                     cterm=none
" static, register, volative
hi StorageClass     guifg=#93d6a9                                   gui=bold
hi StorageClass     ctermfg=115                                     cterm=none
" struct, union, enum
hi Structure        guifg=#93d6a9                                   gui=bold
hi Structure        ctermfg=115                                     cterm=none
" typedef
hi Typedef          guifg=#93d6a9                                   gui=bold
...
hi LineNr           guifg=#818698           guibg=#202020           gui=bold
